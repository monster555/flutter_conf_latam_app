...
import 'package:flutter_conf_latam/dependency_injection.dart';
...
Future<void> main() async {
  ...
  runApp(FCLApp(dependencies: dependencies));
}

class FCLApp extends StatelessWidget {
  const FCLApp({required this.dependencies, super.key});
